#!/bin/bash
# Bull, 8 ranks, correction weight 0.25, level_K = 1 K (mid-loose) --
...
#   level_K = 0.01 K : 132.1 s, 6.37x (job 853360);  5 K : 112.5 s, 7.48x (job 853458)
...
#SBATCH -t 00:30:00
#SBATCH -o logs/bull_eps1_%j.out
#SBATCH -e logs/bull_eps1_%j.err
#SBATCH -p gh
#SBATCH -A ASC21034
...
OUT=outputs/bull_eps1_speedup/par8
echo "###### [$(date)] Bull 8 ranks, weight 0.25, level_K = 1 K ######"
...
echo ""
echo "===== [$(date)] Bull level_K = 1 K speedup ====="
python3 - <<'PY'
import json, pathlib
f = pathlib.Path("outputs/bull_eps1_speedup/par8/timing_summary.json")
if not f.exists():
...
p = json.loads(pathlib.Path("outputs/bull_eps1_speedup/par8/planning_summary.json").read_text())
