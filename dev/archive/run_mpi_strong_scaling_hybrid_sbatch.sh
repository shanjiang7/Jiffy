...
# Runs parallel MPI timing-only jobs for 64 and 32 ranks on hilbert and hybrid_spiral_raster.
#
# Usage:
#   sbatch run_mpi_strong_scaling_hilbert_hybrid_64_32_sbatch.sh

#SBATCH -J segcorr_hh_64_32
#SBATCH -N 4
#SBATCH -n 4
#SBATCH -t 12:00:00
#SBATCH -o logs/segcorr_hh_64_32_%j.out
#SBATCH -e logs/segcorr_hh_64_32_%j.err
#SBATCH -p gh
#SBATCH -A ASC21034
...
PATH_CONFIG_SWEEP=${PATH_CONFIG_SWEEP:-"configs/examples/hybrid_spiral_raster.ini"}
RANK_SWEEP=${RANK_SWEEP:-"1 2 4"}
DT_US=${DT_US:-10}
...
RUN_ROOT=${RUN_ROOT:-outputs/segment_correction_strong_scaling_hilbert_hybrid_64_32_${SLURM_JOB_ID:-manual}}
